...
[![Watch the video](https://img.shields.io/badge/▶️%20Watch%20on-YouTube-red?logo=youtube&style=for-the-badge)](https://youtu.be/Woik6ihrIbM?si=QKr4nxqAqlmMmmkd)
</div>
...
```mermaid
flowchart LR
    US["Five HC-SR04 sensors"] -->|"Trigger / echo"| N["Arduino Nano"]
    N -->|"I2C: five distances"| E["ESP32: main controller"]
    E -->|"I2C: brightness"| N
    N -->|"D12"| LED["NeoPixel lighting"]
    CAM["OpenMV H7 Plus"] -->|"UART: vision data"| E
    E -->|"UART: parking mode"| CAM
    IMU["BNO085"] -->|"I2C: rotation vector"| E
    ENC["Motor encoder"] -->|"Movement pulses"| E
    E -->|"PWM"| SERVO["Steering servo"]
    E -->|"PWM and direction"| DRIVER["TB6612FNG"]
    DRIVER --> MOTOR["DC drive motor"]
```
...
| Arduino Nano, sensors and lights | [Nano_Sensores_I2C__1_.ino](https://github.com/RSA967/Los-Grises-WRO-2026-MX/blob/main/src/Nano_Sensores_I2C__1_.ino) |
...
stateDiagram-v2
    [*] --> SEARCH: three laps
    SEARCH --> PASSING: wall visible or already passed
    PASSING --> ALIGNING: two walls passed
    ALIGNING --> BRAKING: distance or side clearance or phase timeout
    BRAKING --> REVERSE_TURN: 250 ms
    REVERSE_TURN --> REVERSE_STRAIGHT: 240 mm or phase timeout
    REVERSE_STRAIGHT --> DONE: 150 mm or phase timeout
    DONE --> [*]
```
...
| Asset | Use |
|---|---|
| [Part Studio 1.3mf](https://github.com/RSA967/Los-Grises-WRO-2026-MX/raw/refs/heads/main/models/3D%20design%20of%20the%20robot%E2%80%94open%20in%20Onshape.3mf) | View the 24 mesh objects for the body and supports. Check that the viewer respects the meter units. |
