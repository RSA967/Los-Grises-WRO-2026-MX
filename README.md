...
|---------|-------------|-------|--------------|
|IoT FireBeetle ESP32|The DFRobot FireBeetle ESP32 is a compact, low-power development board designed for Internet of Things (IoT) projects and portable devices.

Key Features
Microcontroller: Dual-core ESP32 (up to 240 MHz) with 16 MB of Flash memory and 520 KB of RAM.

Connectivity: Integrated Wi-Fi (2.4 GHz) and Bluetooth 4.2 / BLE.

Ultra-low power consumption: Consumes only 10 µA in Deep Sleep mode.

Power management: Includes a 3.7V Li-Po battery port and an integrated charging circuit via micro-USB / USB-C.

Compatibility: Easily programmable using Arduino IDE, MicroPython, and ESP-IDF.| <div align="center"><img width="500" height="250" alt="OpenMV Cam H7 Plus" src="https://github.com/RSA967/Los-Grises-WRO-2026-MX/blob/main/other/IoT%20FireBeetle%20ESP32.webp?raw=true" /></div> |[Buy here](https://www.amazon.com.mx/UEYGHEP-FireBeetle-Development-Bluetooth-habilitado/dp/B0GFDXH1XS)|
